...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-label-md font-medium transition-colors duration-200 outline-none focus-visible:outline-[3px] focus-visible:outline-primary-container disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        default: "min-h-10 px-[15px] py-1.5",
        lg: "min-h-11 px-5",
